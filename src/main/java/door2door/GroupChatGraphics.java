...
public class GroupChatGraphics extends JFrame {
   ...
   */
  GroupChatGraphics(String myuser1, String areacode) {
    myuser = myuser1;
    ...
    messageLabel = new JLabel("Send a message to the groupchat of your area");
    ...
    gg = new GroupChat(this, messageField, myuser,messageLabel, areacode);
