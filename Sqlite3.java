        ...
        try {
            ...
            while (resultset1.next() ) {
                ...
                if ( resultset1.getString("messages")!= null && resultset1.getString("username")!=null
           		    && resultset1.getString("datetime")!=null && resultset1.getString("Postal Code")!=null ) {

            	    message= resultset1.getString("username")
            		    + ": " + resultset1.getString("messages") + " (" + resultset1.getString("datetime") + ")" + resultset1.getString("Postal Code") ;
